...
## Project Structure
    ...
    ├── our_birth_grant_hol_37379  # Django project configurations
...
1. Clone this repo and `cd our_birth_grant_hol_37379`
...
2. Clone this repo and `cd our_birth_grant_hol_37379`
